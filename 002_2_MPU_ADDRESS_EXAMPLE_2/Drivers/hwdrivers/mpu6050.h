...
#define MPU_6050_I2C_ADDRESS_AD0 ( 0x68 <<1 )
#define MPU_6050_I2C_ADDRESS_AD1 ( 0x69 <<1 )
...
sensor_status_e MPUT6050_set_sleep_mode_on(void);
sensor_status_e MPUT6050_set_sleep_mode_off(void);
sensor_status_e MPU6050_read_data(SensorData_t pSensorData);
sensor_status_e MPU_6050_TestSensor(void);
