...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/fatfs_sd.cyclo ./Core/Src/fatfs_sd.d ./Core/Src/fatfs_sd.o ./Core/Src/fatfs_sd.su ./Core/Src/main.cyclo ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/stm32f4xx_hal_msp.cyclo ./Core/Src/stm32f4xx_hal_msp.d ./Core/Src/stm32f4xx_hal_msp.o ./Core/Src/stm32f4xx_hal_msp.su ./Core/Src/stm32f4xx_it.cyclo ./Core/Src/stm32f4xx_it.d ./Core/Src/stm32f4xx_it.o ./Core/Src/stm32f4xx_it.su ./Core/Src/syscalls.cyclo ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.cyclo ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32f4xx.cyclo ./Core/Src/system_stm32f4xx.d ./Core/Src/system_stm32f4xx.o ./Core/Src/system_stm32f4xx.su ./Core/Src/tcp_echoserver.cyclo ./Core/Src/tcp_echoserver.d ./Core/Src/tcp_echoserver.o ./Core/Src/tcp_echoserver.su ./Core/Src/tftpserver.cyclo ./Core/Src/tftpserver.d ./Core/Src/tftpserver.o ./Core/Src/tftpserver.su ./Core/Src/tftputils.cyclo ./Core/Src/tftputils.d ./Core/Src/tftputils.o ./Core/Src/tftputils.su ./Core/Src/udp_echoserver.cyclo ./Core/Src/udp_echoserver.d ./Core/Src/udp_echoserver.o ./Core/Src/udp_echoserver.su
